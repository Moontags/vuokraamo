...
<div class="container mx-auto py-8 mt-6">
    ...
    <div class="flex justify-between items-center mb-6">
        <h1 class="text-3xl font-bold text-white">Vuokra automme</h1>
        <a href="{{ route('vuokraus.vuokralla') }}" class="bg-yellow-500 hover:bg-yellow-600 text-white px-4 py-2 rounded">Vuokralla</a>
    </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6 m-8">
        ...
        <div class="bg-white rounded shadow-sm p-4 text-center">
            ...
            <h3 class="text-lg font-bold mt-6">{{ $tuote->nimi }}</h3>
