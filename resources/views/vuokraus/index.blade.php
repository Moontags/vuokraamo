...
<div class="container mx-auto py-8">
    ...
    <div class="flex justify-between items-center mb-4">
        ...
        <a href="{{ route('vuokraus.vuokralla') }}" class="bg-blue-500 hover:bg-blue-600 text-white px-4 py-2 rounded">Vuokralla</a>
    </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6 m-8">
        ...
        <div class=" rounded shadow-sm p-4 text-center">
            ...
            <div class="flex justify-center space-x-8">
                <a href="{{ route('vuokraus.create', ['tuoteID' => $tuote->id]) }}" class="bg-blue-500  hover:bg-blue-600 text-white px-4 py-2 rounded mt-4 inline-block">Vuokraa</a>
