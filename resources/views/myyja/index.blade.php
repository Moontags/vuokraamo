        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="border border-gray-300 px-4 py-2">
                    <a href="{{ route('myyja.show', $myyja->id) }}" class="text-blue-500">Katso</a> |
                    <a href="{{ route('myyja.edit', $myyja->id) }}" class="text-yellow-500">Muokkaa</a> |
                    <form action="{{ route('myyja.destroy', $myyja->id) }}" method="POST" class="inline-block">
                        @csrf
                        @method('DELETE')
